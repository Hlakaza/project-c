...
var AppComponent = (function () {
    function AppComponent(authService, toastr, vRef) {
        this.authService = authService;
        this.toastr = toastr;
        this.vRef = vRef;
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof auth_service_1.AuthService !== "undefined" && auth_service_1.AuthService) === "function" && _a || Object, typeof (_b = typeof ng2_toastr_1.ToastsManager !== "undefined" && ng2_toastr_1.ToastsManager) === "function" && _b || Object, typeof (_c = typeof core_1.ViewContainerRef !== "undefined" && core_1.ViewContainerRef) === "function" && _c || Object])
], AppComponent);
...
var FormComponent = (function () {
    ...
    FormComponent.prototype.onFileChange1 = function (event) {
        this.usedSize = 0;
        if (event.target.files1 && event.target.files1.length > 0) {
            for (var i = 0; i < event.target.files1.length; i++) {
    ...
    FormComponent.prototype.onFileChange2 = function (event) {
        this.usedSize = 0;
        if (event.target.files2 && event.target.files2.length > 0) {
            for (var i = 0; i < event.target.files2.length; i++) {
    ...
    FormComponent.prototype.onFileChange3 = function (event) {
        this.usedSize = 0;
        if (event.target.files3 && event.target.files3.length > 0) {
            for (var i = 0; i < event.target.files3.length; i++) {
    ...
    FormComponent.prototype.onFileChange4 = function (event) {
        this.usedSize = 0;
        if (event.target.files4 && event.target.files4.length > 0) {
            for (var i = 0; i < event.target.files4.length; i++) {
    ...
    FormComponent.prototype.onFileChange5 = function (event) {
        this.usedSize = 0;
        if (event.target.files5 && event.target.files5.length > 0) {
            for (var i = 0; i < event.target.files5.length; i++) {
    ...
    FormComponent.prototype.onFileChange6 = function (event) {
        this.usedSize = 0;
        if (event.target.files6 && event.target.files6.length > 0) {
            for (var i = 0; i < event.target.files6.length; i++) {
    ...
    FormComponent.prototype.onFileChange7 = function (event) {
        this.usedSize = 0;
        if (event.target.files7 && event.target.files7.length > 0) {
            for (var i = 0; i < event.target.files7.length; i++) {
    ...
    FormComponent.prototype.onFileChange8 = function (event) {
        this.usedSize = 0;
        if (event.target.files8 && event.target.files8.length > 0) {
            for (var i = 0; i < event.target.files8.length; i++) {
    ...
    FormComponent.prototype.onFileChange9 = function (event) {
        this.usedSize = 0;
        if (event.target.files9 && event.target.files9.length > 0) {
            for (var i = 0; i < event.target.files9.length; i++) {
    ...
    FormComponent.prototype.onFileChange10 = function (event) {
        this.usedSize = 0;
    ...
    //   }
    // }
    FormComponent.prototype.loadFile = function (object, index) {
        var _this = this;
        if (this.usedSize < (1000 * 1000) * this.maxSize) {
            this.account.documentUploader(object)
                .subscribe(function (data) { _this.files[index].success = true; }, function (err) { console.log(err); });
        }
    };
    FormComponent.prototype.removeFile = function (index) {
        this.filesCount -= 1;
...
__decorate([
    core_1.ViewChild('fileInput1'),
    __metadata("design:type", typeof (_b = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" && _b || Object)
], FormComponent.prototype, "fileInput1", void 0);
__decorate([
...
FormComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_o = typeof forms_1.FormBuilder !== "undefined" && forms_1.FormBuilder) === "function" && _o || Object, typeof (_p = typeof ng2_toastr_1.ToastsManager !== "undefined" && ng2_toastr_1.ToastsManager) === "function" && _p || Object, typeof (_q = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _q || Object, typeof (_r = typeof core_1.Renderer !== "undefined" && core_1.Renderer) === "function" && _r || Object, typeof (_s = typeof auth_service_1.AuthService !== "undefined" && auth_service_1.AuthService) === "function" && _s || Object, typeof (_t = typeof form_service_1.FormService !== "undefined" && form_service_1.FormService) === "function" && _t || Object, typeof (_u = typeof profile_service_1.ProfileService !== "undefined" && profile_service_1.ProfileService) === "function" && _u || Object])
], FormComponent);
...
module.exports = "<!--Navbar-->\r\n<nav class=\"navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar\">\r\n    <div class=\"container\">\r\n        <a class=\"navbar-brand\" routerLink=\"/\">\r\n            <img src=\"http://clinixmyvoice.co.za/system/uploads/Clinix%20Health%20Academy/images/logo_white.png\" alt=\"Clinix\" class=\"logo\">\r\n        </a>\r\n        <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent-7\" aria-controls=\"navbarSupportedContent-7\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\r\n            <span class=\"navbar-toggler-icon\"></span>\r\n        </button>\r\n        <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent-7\">\r\n            <ul class=\"navbar-nav mr-auto\">\r\n                <!-- <li class=\"nav-item\"><a class=\"nav-link\" routerLink=\"/user/forms\" *ngIf=\"isLoggedIn() && !isAdmin()\" routerLinkActive=\"active\">Application details</a></li> -->\r\n\r\n                <!-- <li class=\"nav-item white-text\"><a class=\"nav-link\" [routerLink]=\"['admin']\" *ngIf=\"isAdmin()\" routerLinkActive=\"active\">Admin Panel</a></li> -->\r\n            </ul>\r\n            <ul class=\"navbar-right navbar-nav\">\r\n                <!-- \r\n                <li *ngFor=\"let user of fetchedUser\" class=\"nav-item text-right\">\r\n                    <a class=\"nav-link text-orange\" [routerLink]=\"['/user/profile']\" *ngIf=\"isLoggedIn()\">{{user.email}}\r\n                <img *ngIf=\"user.profilePic; else noImage\" src=\"./uploads/profiles/{{user._id}}/{{user.profilePic}}\" onerror=\"this.src ='assets/images/profile-placeholder.jpg';\" class=\"img-resized\" alt=\"avatar\">\r\n                <ng-template #noImage><img src=\"./assets/images/profile-placeholder.png\" class=\"img-resized\"></ng-template>\r\n              </a>\r\n                </li> -->\r\n                <li><a class=\"white-text\" href=\"#\" (click)=\"logout()\" *ngIf=\"isLoggedIn()\">Logout</a></li>\r\n            </ul>\r\n            <span *ngIf=\"!isLoggedIn()\" class=\"white-text phone inline\"><i class=\"mukam-mobile icon-3x pull-left\"></i><a class=\"nav-link text-orange font-bold\" routerLink=\"/user/login\">Admin</a></span>\r\n            <span *ngIf=\"isLoggedIn() && !isAdmin()\" class=\"white-text phone inline\"><i class=\"mukam-mobile icon-3x pull-left\"></i><a class=\"nav-link text-orange font-bold\" routerLink=\"user/forms\">Profile</a></span>\r\n            <span *ngIf=\"isLoggedIn() && isAdmin()\" class=\"white-text phone inline\"><i class=\"mukam-mobile icon-3x pull-left\"></i><a class=\"nav-link text-orange font-bold\" routerLink=\"/admin\">Profile</a></span>\r\n        </div>\r\n    </div>\r\n</nav>"
...
ForgetPasswordComponent = __decorate([
    core_1.Component({
        ...
        styles: [__webpack_require__("./src/app/user/accountRecover/resetPagesStyle.css")]
    }),
...
/***/ "./src/app/user/accountRecover/resetPagesStyle.css":
/***/ (function(module, exports) {
...
var UserProfileComponent = (function () {
    function UserProfileComponent(profileService, router, toastr) {
        this.profileService = profileService;
        this.router = router;
        this.toastr = toastr;
        this.userId = localStorage.getItem('userId');
...
module.exports = "<div class=\"container topPad\">\r\n    <!-- <form [formGroup]=\"myForm\" (ngSubmit)=\"submitEditedForm()\" *ngFor=\"let form of fetchedForm\" class=\"form-horizontal register-form\" novalidate>\r\n        <fieldset>\r\n            <legend class=\"topPad\">Edit Form with id: {{form._id}}</legend>\r\n            <div class=\"form-group\">\r\n                <label class=\"col-md-4 control-label\" for=\"textInputOne\">Text Input One:</label>\r\n                <div class=\"col-md-4\">\r\n                    <input id=\"textInputOne\" #textOne formControlName=\"textInputOne\" name=\"textInputOne\" type=\"text\" [(ngModel)]=\"form.textInputOne\" class=\"form-control input-md\">\r\n                    <div [hidden]=\"textInputOne.valid || textInputOne.pristine\" class=\"alert alert-danger\">Please enter some text</div>\r\n                </div>\r\n            </div>\r\n            <div class=\"form-group\">\r\n                <label class=\"col-md-4 control-label\" for=\"textInputTwo\">Text Input Two:</label>\r\n                <div class=\"col-md-4\">\r\n                    <input id=\"textInputTwo\" formControlName=\"textInputTwo\" name=\"textInputTwo\" type=\"text\" [(ngModel)]=\"form.textInputTwo\" class=\"form-control input-md\">\r\n                    <div [hidden]=\"textInputTwo.valid || textInputTwo.pristine\" class=\"alert alert-danger\">Please enter some text</div>\r\n                </div>\r\n            </div>\r\n\r\n            <div class=\"form-group\">\r\n                <div class=\"col-md-4 col-centered\">\r\n                    <div class=\"profilePictureTempEdit\">\r\n                        <button *ngIf=\"submitStarted\" class=\"disabled btn-no-hover btn btn-default centered progress-button\">\r\n              <i class=\"fa fa-circle-o-notch fa-spin fa-fw\"></i> Please wait... <span class=\"progress-percent\">{{progress}}%</span>\r\n            </button>\r\n                        <div class=\"text-center top-margin\">\r\n                            <div class=\"profilePictureTempEdit\" *ngIf=\"oldImage\">\r\n                                <img class=\"img-responsive\" src=\"./uploads/forms/{{form.owner}}/{{form.imagePath}}\" alt=\"image\" onerror=\"this.src ='assets/images/no-image.jpg';\">\r\n                                <div class=\"upload-button\" *ngIf=\"!imageReady\">\r\n                                    <input type=\"file\" name=\"file-1\" id=\"file-1\" class=\"inputfile4 inputfile-4\" (change)=\"onFileSelect($event)\">\r\n                                    <label for=\"file-1\">\r\n                <span>\r\n                </span>\r\n                  </label>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"profilePictureTempEdit\">\r\n                                <img *ngIf=\"imageReady\" #image class=\"img-responsive\" src=\"{{imageUrl}}{{imagePath}}\" alt=\"image\" onerror=\"this.src ='assets/images/no-image.jpg';\" />\r\n                                <div class=\"upload-button\">\r\n                                    <input type=\"file\" name=\"file-2\" id=\"file-2\" class=\"inputfile4 inputfile-4\" (change)=\"onFileSelect($event)\">\r\n                                    <label for=\"file-2\">\r\n                  <span>\r\n                  </span>\r\n                  </label>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n\r\n            /*Submit Button */\r\n            <div class=\"form-group\">\r\n                <div class=\"col-md-4 col-centered\">\r\n                    <button type=\"submit\" [disabled]=\"!myForm.valid && myForm.untouched\" id=\"submitForm\" name=\"sumbitForm\" class=\"btn btn-primary text-center bottomMargin\">Submit</button>\r\n                    <button type=\"button\" class=\"btn btn-warning\" (click)=\"cancel()\">Cancel</button>\r\n                </div>\r\n            </div>\r\n        </fieldset>\r\n    </form> -->\r\n\r\n\r\n\r\n    <div class=\"flex-center\">\r\n        <div class=\"card reg-card-width\">\r\n            <div class=\"card-body\">\r\n                <!--Header-->\r\n                <div class=\"form-header bg-deep-orange \">\r\n                    <h3><i class=\"fa fa-user\"></i> Update your details:</h3>\r\n                </div>\r\n                <form [formGroup]=\"myForm\" (ngSubmit)=\"submitEditedForm()\" *ngFor=\"let form of fetchedForm\" class=\"form-horizontal register-form clearfix\" novalidate>\r\n                    <fieldset>\r\n                        <!-- Form Name -->\r\n                        <!-- <legend class=\"text-center topPad\">Fill In All The Required Fields</legend> -->\r\n                        <app-tabs #t>\r\n                            <app-tab title=\"Company Information\">\r\n                                <div class=\"row\">\r\n                                    <!--Trading Name-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-building prefix grey-text\"></i>\r\n                                                <input placeholder=\"Trading Name\" class=\"form-control\" formControlName=\"tradingName\" name=\"tradingName\" type=\"text\" [(ngModel)]=\"form.tradingName\" required/>\r\n                                                <!-- <label for=\"tradingName\">Trading Name</label> -->\r\n                                                <span *ngIf=\"myForm.get('tradingName').hasError('required') && myForm.get('tradingName').touched\" class=\"help-block text-danger\">Trading Name is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <!--Company Name-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\" [ngClass]=\"{ 'has-error': myForm.get('registeredCompanyName').hasError('required') && myForm.get('registeredCompanyName').touched }\">\r\n                                                <i class=\"fa fa-building prefix grey-text\"></i>\r\n                                                <input placeholder=\"Registered Company Name\" class=\"form-control\" formControlName=\"registeredCompanyName\" name=\"registeredCompanyName\" [(ngModel)]=\"form.registeredCompanyName\" type=\"text\" />\r\n                                                <!-- <label for=\"registeredCompanyName\">Registered Company Name</label> -->\r\n                                                <span *ngIf=\"myForm.get('registeredCompanyName').hasError('required') && myForm.get('registeredCompanyName').touched\" class=\"help-block text-danger\">Company Name is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Registration Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\" [ngClass]=\"{ 'has-error': myForm.get('registrationNumber').hasError('required') && myForm.get('registrationNumber').touched }\">\r\n                                                <i class=\"fa fa-edit prefix grey-text\"></i>\r\n                                                <input placeholder=\"Registration Number\" class=\"form-control\" formControlName=\"registrationNumber\" name=\"registrationNumber\" type=\"text\" [(ngModel)]=\"form.registrationNumber\" />\r\n                                                <!-- <label for=\"registrationNumber\">Registration Number</label> -->\r\n                                                <span *ngIf=\"myForm.get('registrationNumber').hasError('required') && myForm.get('registrationNumber').touched\" class=\"help-block text-danger\">Registration Number is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                                <!--Vat Number-->\r\n                                                <div class=\"col-md-6\">\r\n                                                    <div class=\"md-form\">\r\n                                                        <i class=\"fa fa-archive prefix grey-text\"></i>\r\n                                                        <input placeholder=\"Vat Number\" type=\"text\" class=\"form-control\" formControlName=\"vatNumber\" name=\"vatNumber\" [(ngModel)]=\"form.vatNumber\" />\r\n                                                        <!-- <label for=\"vatNumber\">Vat Number</label> -->\r\n                                                        <span *ngIf=\"myForm.get('vatNumber').hasError('required') && myForm.get('vatNumber').touched\" class=\"help-block text-danger\">VatNumber is required</span>\r\n                                                    </div>\r\n                                                </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Address-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"md-form\">\r\n                                            <i class=\"far fa-address-card prefix grey-text\"></i>\r\n                                            <textarea placeholder=\"Physical Address\" type=\"text\" formControlName=\"physicalAddress\" name=\"physicalAddress\" class=\"form-control md-textarea\" [(ngModel)]=\"form.physicalAddress\"></textarea>\r\n                                            <!-- <label for=\"physicalAddress\">Physical Address</label> -->\r\n                                            <span *ngIf=\"myForm.get('physicalAddress').hasError('required') && myForm.get('physicalAddress').touched\" class=\"help-block text-danger\">Physical Address is required</span>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Postal Address-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"md-form\">\r\n                                            <i class=\"far fa-address-card prefix grey-text\"></i>\r\n                                            <textarea type=\"text\" placeholder=\"Postal Address\" formControlName=\"postalAddress\" name=\"postalAddress\" class=\"form-control md-textarea\" [(ngModel)]=\"form.postalAddress\"></textarea>\r\n                                            <!-- <label for=\"postalAddress\">Postal Address</label> -->\r\n                                            <span *ngIf=\"myForm.get('postalAddress').hasError('required') && myForm.get('postalAddress').touched\" class=\"help-block text-danger\">Postal Address is required</span>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Phone Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"md-form \">\r\n                                            <i class=\"fa fa-phone prefix grey-text\"></i>\r\n                                            <input placeholder=\"Work Tel Number\" type=\"text\" class=\"form-control\" formControlName=\"tel\" name=\"tel\" [(ngModel)]=\"form.tel\" />\r\n                                            <!-- <label for=\"tel\">Telephone Number</label> -->\r\n                                            <span *ngIf=\"myForm.get('tel').hasError('required') && myForm.get('tel').touched\" class=\"help-block text-danger\" >Your work Telephone Number is required</span>\r\n                                        </div>\r\n                                    </div>\r\n\r\n                                    <!--Fax Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"md-form\">\r\n                                            <i class=\"fa fa-fax prefix grey-text\"></i>\r\n                                            <input placeholder=\"Fax Number\" type=\"text\" class=\"form-control\" formControlName=\"faxNo\" name=\"faxNo\" [(ngModel)]=\"form.faxNo\"/>\r\n                                            <!-- <label for=\"faxNo\">Fax Number</label> -->\r\n                                            <span *ngIf=\"myForm.get('faxNo').hasError('required') && myForm.get('faxNo').touched\" class=\"help-block text-danger\">Fax number is required</span>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Website-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"md-form\">\r\n                                            <i class=\"fa fa-globe prefix grey-text\"></i>\r\n                                            <textarea placeholder=\"Website\" type=\"text\" formControlName=\"website\" name=\"website\" class=\"form-control md-textarea\" [(ngModel)]=\"form.website\"></textarea>\r\n                                            <!-- <label for=\"website\">Website</label> -->\r\n                                            <span *ngIf=\"myForm.get('website').hasError('required') && myForm.get('website').touched\" class=\"help-block text-danger\">Website is required</span>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <button class=\"btn btn-success\" (click)=\"t.selectTab(1)\">Next</button>\r\n                            </app-tab>\r\n                            <app-tab title=\"Correspondence\">\r\n                                <div class=\"row\">\r\n                                    <!--Acc Person  Name-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-user prefix grey-text\"></i>\r\n                                                <input placeholder=\"Accounts Person Name\" class=\"form-control\" formControlName=\"accPersonName\" name=\"accPersonName\" type=\"text\" [(ngModel)]=\"form.accPersonName\"/>\r\n                                                <span *ngIf=\"myForm.get('accPersonName').hasError('required') && myForm.get('accPersonName').touched\" class=\"help-block text-danger\">Accounts Person Name is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Acc Person Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\" [ngClass]=\"{ 'has-error': myForm.get('accPersonNo').hasError('required') && myForm.get('accPersonNo').touched }\">\r\n                                                <i class=\"fa fa-phone prefix grey-text\"></i>\r\n                                                <input placeholder=\"Work Tel Number\" class=\"form-control\" formControlName=\"accPersonNo\" name=\"accPersonNo\" type=\"text\" [(ngModel)]=\"form.accPersonNo\"/>\r\n                                                <span *ngIf=\"myForm.get('accPersonNo').hasError('required') && myForm.get('accPersonNo').touched\" class=\"help-block text-danger\">Phone Number is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <!--Acc Person Fax Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-fax prefix grey-text\"></i>\r\n                                                <input placeholder=\"Fax Number\" type=\"text\" class=\"form-control\" formControlName=\"accPersonFaxNo\" name=\"accPersonFaxNo\" [(ngModel)]=\"form.accPersonFaxNo\"/>\r\n                                                <span *ngIf=\"myForm.get('accPersonFaxNo').hasError('accPersonFaxNo') && myForm.get('accPersonFaxNo').touched\" class=\"help-block text-danger\">Fax Number is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Email-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"clearfix\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"far fa-envelope prefix grey-text\"></i>\r\n                                                <input placeholder=\"Email\" type=\"email\" class=\"form-control\" formControlName=\"accPersonEmail\" name=\"accPersonEmail\" [(ngModel)]=\"form.accPersonEmail\"/>\r\n                                                <span *ngIf=\"myForm.get('accPersonEmail').hasError('required') && myForm.get('accPersonEmail').touched\" class=\"help-block text-danger\">Email is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n\r\n                                <div class=\"row\">\r\n                                    <!--Sales Person  Name-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-user prefix grey-text\"></i>\r\n                                                <input placeholder=\"Sales Person Name\" class=\"form-control\" formControlName=\"salesPersonName\" name=\"salesPersonName\" type=\"text\" [(ngModel)]=\"form.salesPersonName\"/>\r\n                                                <span *ngIf=\"myForm.get('salesPersonName').hasError('required') && myForm.get('salesPersonName').touched\" class=\"help-block text-danger\">Sales Person Name is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Sales Person Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-phone prefix grey-text\"></i>\r\n                                                <input placeholder=\"Work Tel Number\" class=\"form-control\" formControlName=\"salesPersonNo\" name=\"salesPersonNo\" type=\"text\" [(ngModel)]=\"form.salesPersonNo\"/>\r\n                                                <span *ngIf=\"myForm.get('salesPersonNo').hasError('required') && myForm.get('salesPersonNo').touched\" class=\"help-block text-danger\">Phone Number is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <!--Sales Person Fax Number-->\r\n                                    <div class=\"col-md-6\">\r\n                                        <div class=\"clearfix pad-top-10\">\r\n                                            <div class=\"md-form\">\r\n                                                <i class=\"fa fa-fax prefix grey-text\"></i>\r\n                                                <input placeholder=\"Fax Number\" type=\"text\" class=\"form-control\" formControlName=\"salesPersonFaxNo\" name=\"salesPersonFaxNo\" [(ngModel)]=\"form.salesPersonFaxNo\"/>\r\n                                                <span *ngIf=\"myForm.get('salesPersonFaxNo').hasError('salesPersonFaxNo') && myForm.get('salesPersonFaxNo').touched\" class=\"help-block text-danger\">Fax Number is required</span>\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"row\">\r\n                                    <!--Email-->\r\n                                    <div class=\"col-md-12\">\r\n                                        <div class=\"md-form\">\r\n                                            <i class=\"far fa-envelope prefix grey-text\"></i>\r\n                                            <input placeholder=\"Email\" type=\"email\" class=\"form-control\" formControlName=\"salesPersonEmail\" name=\"salesPersonEmail\" [(ngModel)]=\"form.salesPersonEmail\"/>\r\n                                            <span *ngIf=\"myForm.get('salesPersonEmail').hasError('required') && myForm.get('salesPersonEmail').touched\" class=\"help-block text-danger\">Email is required</span>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n\r\n                                <button class=\"btn btn-success\" (click)=\"t.selectTab(2)\">Next</button>\r\n                            </app-tab>\r\n                            <app-tab title=\"Rquired Documents\">\r\n                                <!-- /**\r\n                ////////////\r\n                Upload Files\r\n                ////////////\r\n                */ -->\r\n                                <div class=\"row\">\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Custom General Terms and Conditions\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"BEE Certificate\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                    <div class=\"col-sm-12\">\r\n                                        <div class=\"file-field\">\r\n                                            <div class=\"btn btn-primary btn-sm\">\r\n                                                <span>Choose file</span>\r\n                                                <input type=\"file\">\r\n                                            </div>\r\n                                            <div class=\"file-path-wrapper\">\r\n                                                <input class=\"file-path validate\" type=\"text\" placeholder=\"Upload your file\">\r\n                                            </div>\r\n                                        </div>\r\n                                    </div>\r\n                                </div>\r\n                            </app-tab>\r\n                        </app-tabs>\r\n\r\n                        <!-- Button -->\r\n                        <div class=\"form-group\">\r\n                            <div class=\"col-md-12 flex-center\">\r\n                                <!-- Submit Button -->\r\n                                <div class=\"form-group\">\r\n                                    <div class=\"col-md-4 col-centered\">\r\n                                        <button type=\"submit\" [disabled]=\"!myForm.valid && myForm.untouched\" id=\"submitForm\" name=\"sumbitForm\" class=\"btn btn-primary text-center bottomMargin\">Submit</button>\r\n                                        <button type=\"button\" class=\"btn btn-warning\" (click)=\"cancel()\">Cancel</button>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </fieldset>\r\n                </form>\r\n            </div>\r\n        </div>\r\n    </div>"
...
module.exports = "<!-- <table class=\"table table-hover table-responsive table-condensed\">\r\n    <thead>\r\n    <tr>\r\n      <th>Image</th>\r\n      <th>Form ID</th>\r\n      <th>Text Input One</th>\r\n      <th>Text Input Two</th>\r\n      <th>Owner</th>\r\n      <th>Date Submitted</th>\r\n      <th>Date Edited</th>\r\n      <th>Edit</th>\r\n      <th>Delete</th>\r\n    </tr>\r\n    </thead>\r\n    <tbody>\r\n    <tr *ngFor=\"let form of fetchedForms\">\r\n      <td class=\"img-resized\"><img class=\"img-thumbnail img-responsive\" src=\"./uploads/forms/{{form.owner}}/{{form.imagePath}}\" onerror=\"this.src ='assets/images/no-image.jpg';\"></td>\r\n      <td>{{form._id }}</td>\r\n      <td>{{form.textInputOne}}</td>\r\n      <td>{{form.textInputTwo}}</td>\r\n      <td>{{form.owner}}</td>\r\n      <td>{{form.dateSubmitted | date: 'medium'}}</td>\r\n      <td>\r\n        <span *ngIf=\"form.dateSubmitted != form.updatedAt\">{{form.updatedAt | date: 'medium'}}</span>\r\n      </td>\r\n      <td>\r\n        <button class=\"btn-default\" [routerLink]=\"['edit', form._id]\"><i class=\"fa fa-pencil\"></i></button>\r\n      </td>\r\n      <td>\r\n        <button class=\"btn-danger\" (click)=\"onDelete(form._id)\"><i class=\"fa fa-trash\"></i></button>\r\n    </td>\r\n</tr>\r\n</tbody>\r\n</table> -->\r\n\r\n<section class=\"dash-wraper\">\r\n    <section id=\"sidebar\">\r\n        <div class=\"white-label\">\r\n            <img src=\"http://clinixmyvoice.co.za/system/uploads/Clinix%20Health%20Academy/images/logo_white.png\" alt=\"Clinix\">\r\n        </div>\r\n        <div id=\"sidebar-nav\">\r\n            <ul>\r\n                <li class=\"active\"><a class=\"marg-6 btn  btn-blue-grey\" routerLink=\"/form\"> Add Details</a></li>\r\n                <li><a class=\"marg-6 spacing-top btn btn-deep-orange\" routerLink=\"/user/forms\">Profile</a></li>\r\n\r\n            </ul>\r\n        </div>\r\n    </section>\r\n    <section id=\"content\">\r\n        <div id=\"header\">\r\n            <div class=\"header-nav\">\r\n                <div class=\"menu-button\">\r\n                    <!--<i class=\"fa fa-navicon\"></i>-->\r\n                </div>\r\n                <div class=\"widget-nav\">\r\n                    <ul>\r\n                        <li class=\"widget-nav-item nav-chat\">\r\n                            <div (click)=\"logout()\" class=\"cursor-pointer font-icon\"><i class=\"fa fa-sign-out-alt\"></i> Logout</div>\r\n                        </li>\r\n                        <li class=\"widget-nav-item nav-profile\">\r\n                            <div class=\"nav-profile-image\" *ngFor=\"let user of fetchedUser\">\r\n                                <img src=\"https://upload.wikimedia.org/wikipedia/commons/6/67/User_Avatar.png\" alt=\"profile image\">\r\n                                <div class=\"nav-profile-name\">{{user.email}} <i class=\"fa fa-caret-down\"></i></div>\r\n                            </div>\r\n                        </li>\r\n                    </ul>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"content\">\r\n            <div class=\"pad-top-header\">\r\n                <div class=\"main-content marg-auto\">\r\n                    <div class=\"container-fluid\">\r\n                        <div class=\"col-sm-12\">\r\n                            <div class=\"card spacing-bottom\" *ngFor=\"let form of fetchedForms\">\r\n                                <div class=\"card-header\" data-background-color=\"red\">\r\n                                    <h4 class=\"title\">Welcome {{form.tradingName}}</h4>\r\n                                    <p class=\"category\">These are your details</p>\r\n\r\n                                </div>\r\n                                <div class=\"card-content table-responsive\">\r\n                                    <table class=\"table\">\r\n                                        <thead class=\"text-danger\">\r\n                                            <th>Company Information</th>\r\n                                            <th>Correspondecne</th>\r\n                                            <th>Documents</th>\r\n                                        </thead>\r\n                                        <tbody>\r\n                                            <tr>\r\n                                                <td>Trading Name: {{form.tradingName}}</td>\r\n                                                <td>Acc PersonName: {{form.accPersonName}}</td>\r\n                                                <td>Doc: Customer General Terms and Conditions of Supply</td>\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Registered Name: {{form.tradingName}}</td>\r\n                                                <td>Acc Person No: {{form.accPersonNo}}</td>\r\n                                                <td>Doc: BEE Certificate</td>\r\n\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Physical Address: {{form.physicalAddress}}</td>\r\n                                                <td>Acc Person Fax No: {{form.accPersonFaxNo}}</td>\r\n                                                <td>Doc: Letter of Good Standing</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Postal Address: {{form.postalAddress}}</td>\r\n                                                <td>Acc Person Email: {{form.accPersonEmail}}</td>\r\n                                                <td>Doc: Audited latest Financial Statements</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Tel: {{form.tel}}</td>\r\n                                                <td>Sales Person Name: {{form.salesPersonName}}</td>\r\n                                                <td>Doc: Proof of Banking Details</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Fax: {{form.faxNo}}</td>\r\n                                                <td>Sales Person No: {{form.salesPersonNo}}</td>\r\n\r\n                                                <td>Doc: Company Letterhead</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Website: {{form.website}}</td>\r\n                                                <td>Sales Person FaxNo: {{form.salesPersonFaxNo}}</td>\r\n                                                <td>Doc: Tax Certificate</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>Vat Number: {{form.vatNumber}}</td>\r\n                                                <td>Sales Person Email: {{form.salesPersonEmail}}</td>\r\n                                                <td>Doc: MCC Certificate</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>Doc: Declaration of possible conflict of Interest with Clinix Health Group (CHG)</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>Doc: identity Documents</td>\r\n\r\n                                            </tr>\r\n                                            <tr>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>&nbsp;&nbsp;&nbsp;</td>\r\n                                                <td>Doc: Product price lists </td>\r\n\r\n                                            </tr>\r\n\r\n                                        </tbody>\r\n                                    </table>\r\n                                    <!-- <a [routerLink]=\"['/login']\" class=\"btn btn-default\">Logout</a> -->\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n\r\n                    </div>\r\n                </div>\r\n\r\n            </div>\r\n\r\n        </div>\r\n    </section>\r\n</section>"
